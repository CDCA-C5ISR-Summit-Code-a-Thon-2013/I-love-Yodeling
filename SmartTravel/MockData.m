...
- (NSArray*) getLocationData
{
    ...
    [locationArray addObject:[[Location alloc] initWithName:@"Applebee's" andAddress:@"4910 Ashley Phosphate Road" andCoordinate:CLLocationCoordinate2DMake(32.918088, -80.103746)]];
    
    // Outback 32.95452,-80.038254 7643 Rivers Avenue
    [locationArray addObject:[[Location alloc] initWithName:@"Outback Steakhouse" andAddress:@"7643 Rivers Avenue" andCoordinate:CLLocationCoordinate2DMake(32.95452, -80.038254)]];
    
    // Outback 32.814401,-80.025895 1890 Sam Rittenberg Boulevard
    [locationArray addObject:[[Location alloc] initWithName:@"Outback Steakhouse" andAddress:@"1890 Sam Rittenberg Boulevard" andCoordinate:CLLocationCoordinate2DMake(32.814401, -80.025895)]];
    
    // Outback 32.825942,-79.880326 715 Johnnie Dodds Boulevard
    [locationArray addObject:[[Location alloc] initWithName:@"Outback Steakhouse" andAddress:@"715 Johnnie Dodds Boulevard" andCoordinate:CLLocationCoordinate2DMake(32.825942, -79.880326)]];
    
    // Page's (32.791189,-79.877175) Okra Grill 302 Coleman Boulevard
    [locationArray addObject:[[Location alloc] initWithName:@"Page's Okra Grill" andAddress:@"302 Coleman Boulevard" andCoordinate:CLLocationCoordinate2DMake(32.791189, -79.877175)]];
