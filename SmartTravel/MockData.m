...
- (NSArray*) getLocationData
{
    ...
    [locationArray addObject:[[Location alloc] initWithName:@"Page's Okra Grill" andAddress:@"302 Coleman Boulevard" andImage:@"pagesbackground.jpg" andLogo:@"pages.jpg" andDealText:@"20% off all entrees for veterans and active duty military." andCoordinate:CLLocationCoordinate2DMake(32.791189, -79.877175)]];
