...
- (NSArray*) getLocationData
{
    ...
    [locationArray addObject:[[Location alloc] initWithName:@"Page's Okra Grill" andAddress:@"302 Coleman Boulevard" andImage:@"" andLogo:@"pages.jpg" andDealText:@"20% off all entrees for veterans and active duty military." andCoordinate:CLLocationCoordinate2DMake(32.791189, -79.877175)]];
    
    // Market Pavilion Hotel
    [locationArray addObject:[[Location alloc] initWithName:@"Market Pavilion Hotel" andAddress:@"225 East Bay Street" andImage:@"" andLogo:@"marketpavilionlogo.jpg" andDealText:@"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec nibh ac leo blandit vestibulum in quis turpis. Nunc convallis consectetur tortor eu sodales. Sed ut enim dolor. Vestibulum vitae sodales tellus. Cras vulputate odio vel feugiat eleifend. Duis in est quis erat dapibus pulvinar vel id tortor. Curabitur et porttitor ante, nec interdum lectus. Fusce a mauris et eros tristique ultrices nec non nisl." andCoordinate:CLLocationCoordinate2DMake(32.781024, -79.927685)]];
    
    // The Mills House Hotel
    [locationArray addObject:[[Location alloc] initWithName:@"The Mills House Hotel" andAddress:@"115 Meeting Street" andImage:@"" andLogo:@"millhouselogo.jpg" andDealText:@"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec nibh ac leo blandit vestibulum in quis turpis. Nunc convallis consectetur tortor eu sodales. Sed ut enim dolor. Vestibulum vitae sodales tellus. Cras vulputate odio vel feugiat eleifend. Duis in est quis erat dapibus pulvinar vel id tortor. Curabitur et porttitor ante, nec interdum lectus. Fusce a mauris et eros tristique ultrices nec non nisl." andCoordinate:CLLocationCoordinate2DMake(32.778002, -79.931762)]];
