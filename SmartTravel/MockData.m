...
- (NSArray*) getLocationData
{
    ...
    [locationArray addObject:[[Location alloc] initWithName:@"Outback Steakhouse" andAddress:@"7643 Rivers Avenue" andImage:@"outback.JPG" andDealText:@"Active duty members of the military can enjoy a 20% discount on all items!" andCoordinate:CLLocationCoordinate2DMake(32.95452, -80.038254)]];
